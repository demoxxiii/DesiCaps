...
|---|---|---|
| Whisper-Hindi2Hinglish-Apex (speech model, converted to ggml) | Apache-2.0 | https://huggingface.co/Oriserve/Whisper-Hindi2Hinglish-Apex |
| OpenAI Whisper large-v3-turbo (optional Hindi/English model) | MIT | https://huggingface.co/ggerganov/whisper.cpp |
...
Source code for every GPL component can be obtained from the links above. DesiCaps Studio's own source code is this repository.
